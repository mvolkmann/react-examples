...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_greeting2['default'], { greet: 'Hola' }), document.body);
	//React.render(<HelloWorld greet="7"/>, document.body);
	...
	var Greeting = (function (_React$Component) {
	  ...
	  */
	  ...
	  function Greeting(props) {
	    ...
	    _get(Object.getPrototypeOf(Greeting.prototype), 'constructor', this).call(this, props);
	    this.displayName = 'Greeting';
	    this.state = { name: 'World' };
	  }

	  /*
	  // This is not enforcing the type of the greet prop!
	  // If you use the commented out line below where greet is 7
	  // no warning appears in the console.
	  Greeting.propTypes = {
	    greet: React.PropTypes.string
	  }
	  */
	  ...
	  _createClass(Greeting, [{
	    ...
	    value: function render() {
	      // Parens around the returned JSX are not required.
